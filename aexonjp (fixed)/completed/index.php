<?php session_start();
    ...
    $ongoing = mysqli_query($conn, "SELECT * FROM completed ORDER BY $bruhs $bruh;");
    $ongoings = mysqli_query($conn, "SELECT `judul` FROM completed ORDER BY $bruhs $bruh;");
 ?>
