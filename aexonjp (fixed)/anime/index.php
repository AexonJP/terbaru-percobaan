<?php session_start();
    ...
    $ongoing = mysqli_query($conn, "SELECT * FROM ongoing WHERE `$bruhs` LIKE '%$cari%' UNION SELECT * FROM movie WHERE `$bruhs` LIKE '%$cari%' UNION SELECT * FROM completed  WHERE `$bruhs` LIKE '%$cari%' ORDER BY $bruhs $bruh;");
    $ongoings = mysqli_query($conn, "SELECT * FROM ongoing WHERE `$bruhs` LIKE '%$cari%' UNION SELECT * FROM movie WHERE `$bruhs` LIKE '%$cari%' UNION SELECT * FROM completed  WHERE `$bruhs` LIKE '%$cari%' ORDER BY $bruhs $bruh;");
    ?>
