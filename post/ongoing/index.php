<?php session_start();
    ...
    $ongoing = mysqli_query($conn, "SELECT * FROM ongoing ORDER BY $bruhs $bruh;");
    $ongoings = mysqli_query($conn, "SELECT `judul` FROM ongoing ORDER BY $bruhs $bruh;");
 ?>
